...
export class MaterialGroupUpsertComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.commonService.setNavTittleAndMenu(" Material Group Details");
  }
  ...
  backToHome(){
    this.router.navigateByUrl('home/master/materialGroup');
  }
